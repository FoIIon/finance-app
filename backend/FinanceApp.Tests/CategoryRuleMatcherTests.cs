...
public class CategoryRuleMatcherTests
{
    ...
    {
        Assert.True(CategoryRuleMatcher.Matches("colruyt", "COLRUYT DEMOVILLE", null));
        Assert.True(CategoryRuleMatcher.Matches("Martin", "Virement", "MARTIN GILLE"));
        Assert.False(CategoryRuleMatcher.Matches("Delhaize", "COLRUYT DEMOVILLE", "COLRUYT"));
    }
