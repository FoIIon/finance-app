...
{
    private static readonly string[] Titulaires = ["DUPONT - MARTIN", "Mr SÉBASTIEN DUPONT"];
    ...
    [
        new(482, new DateTime(2026, 8, 14), 171.70m, IsExpense: true, "Sebastien Jean R Dupont"),
        new(483, new DateTime(2026, 8, 13), 130.90m, IsExpense: true, "Sebastien Jean R Dupont"),
        new(484, new DateTime(2026, 8, 13), 32.70m, IsExpense: true, "Sebastien Jean R Dupont"),
    ...
    public void FindMirror_PlusieursCandidats_PrendLePlusProcheDansLeTemps()
    {
        ...
        [
            new(900, Aout14.AddDays(2), 50.00m, IsExpense: true, "Sebastien Jean R Dupont"),
            new(901, Aout14, 50.00m, IsExpense: true, "Sebastien Jean R Dupont"),
        ];
    ...
    public void FindMirror_ADateEgale_PrendLePlusAncienEnBase()
    {
        TransferLeg[] candidats =
        [
            new(902, Aout14, 50.00m, IsExpense: true, "Sebastien Jean R Dupont"),
            new(901, Aout14, 50.00m, IsExpense: true, "Sebastien Jean R Dupont"),
        ];
    ...
    public void FindMirror_DepenseDeVacancesSansMouvementTrCorrespondant_ResteIntacte()
    {
        ...
        [
            new(503, new DateTime(2026, 8, 3), 380.00m, IsExpense: true, "Sebastien Jean R Dupont"),
            new(490, new DateTime(2026, 8, 10), 192.44m, IsExpense: true, "Sebastien Jean R Dupont"),
        ];
