    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a1a] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-8">
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
          ...
          <p className="text-center text-white/40 mb-8">Connexion à votre compte</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm text-white/60 mb-2">Mot de passe</label>
              <input
                id="login-password"
                type="password"
                value={password}
